// Enhanced by AI on 2025-08-12T11:43:50.093Z
// Section: footer
// Category: footer
...
export default function Footer() {
  const footerSections = [
    {
      ...
      links: [
        ...
        { name: "Technology Advisory", href: "/services/technology" },
        { name: "Industry Expertise", href: "/services/industry-expertise" }
      ]
    },
    {
      title: "Company",
  ...
  const socialLinks = [
    { name: "Twitter", icon: Twitter, href: "https://twitter.com/consultingfirm" },
    { name: "Facebook", icon: Facebook, href: "https://facebook.com/consultingfirm" },
    { name: "Instagram", icon: Instagram, href: "https://instagram.com/consultingfirm" },
    { name: "LinkedIn", icon: Linkedin, href: "https://linkedin.com/company/consultingfirm" },
    { name: "GitHub", icon: Github, href: "https://github.com/consultingfirm" }
  ]
          ...
          <div className="lg:col-span-2 space-y-6">
            <div>
              ...
              <p className="text-muted-foreground text-sm leading-relaxed mb-6">
                Empowering businesses to achieve their full potential through strategic consulting and innovative solutions.
              </p>
            </div>
